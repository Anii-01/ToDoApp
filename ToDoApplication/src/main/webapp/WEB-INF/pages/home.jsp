      ...
      <div class="col-md-4 mb-3">
        <div class="card menu-card">
          ...
          <div class="list-group list-group-flush">
            <a href='<c:url value="/add"/>' class="list-group-item list-group-item-action bg-transparent border-0">➕ Add ToDo</a>
            <a href='<c:url value="/home"/>' class="list-group-item list-group-item-action bg-transparent border-0">📋 View ToDos</a>
          </div>
        </div>
      </div>
            ...
            <c:forEach items="${todos}" var="t">
              <div class="col">
                <div class="card card-custom">
                  <div class="card-body">
                    <h5 class="fw-bold"><c:out value="${t.todoTitle}"></c:out></h5>
                    <p class="text-muted"><c:out value="${t.todoContent}"></c:out></p>
                  </div>
                </div>
              </div>
            </c:forEach>
